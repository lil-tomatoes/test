...
CMDs[#CMDs + 1] = {NAME = 'grab / drag', DESC = 'grab player'}

CMDs[#CMDs + 1] = {NAME = 'mask', DESC = 'get mask'}
CMDs[#CMDs + 1] = {NAME = 'pan', DESC = 'get pan'}
CMDs[#CMDs + 1] = {NAME = 'shovel', DESC = 'get shovel'}
CMDs[#CMDs + 1] = {NAME = 'leash', DESC = 'get leash'}
CMDs[#CMDs + 1] = {NAME = 'food', DESC = 'get food'}
CMDs[#CMDs + 1] = {NAME = 'drink', DESC = 'get drink'}
CMDs[#CMDs + 1] = {NAME = 'hos', DESC = 'Tp to hos'}
CMDs[#CMDs + 1] = {NAME = 'nails', DESC = 'auto train nails'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'autoclick', DESC = 'Automatically attacks'}
...
CMDs[#CMDs + 1] = {NAME = 'wallclimb / wc', DESC = 'Lets you climb on stuff'}
CMDs[#CMDs + 1] = {NAME = 'unwallclimb / unwc', DESC = 'Lets you not climb on stuff'}
CMDs[#CMDs + 1] = {NAME = 'bodygrab / bg', DESC = 'Puts a players bodypart near you so you can attack it.'}
CMDs[#CMDs + 1] = {NAME = 'graball / bgall', DESC = 'Puts a players bodypart near you so you can attack it.'}
CMDs[#CMDs + 1] = {NAME = 'unbodygrab / unbg', DESC = 'Stops the bodypart from teleporting to you, dont go back to normal.'}
wait()
...
addcmd('wallclimb',{'wc'},function(args, speaker)
	...
	cube = Instance.new("TrussPart")
	cube.Anchored = true
	cube.Size = Vector3.new(0.4,2048,0.4)
	...
	rayParams.FilterDescendantsInstances = {cube,speaker.Character}

	climb = RunService.RenderStepped:Connect(function()
		if not head or not head.Parent then return end

		local origin = head.Position - Vector3.new(0,2,0)
		local direction = head.CFrame.LookVector * 2.5
		
		local result = workspace:Raycast(origin, direction, rayParams)

		if result and canuse then
			cube.Position = result.Position
		else
			cube.Position = Vector3.new(9999999,9999999,9999999)
			canuse = false
			wait(0.3)
			canuse = true
		end
...
addcmd('unwallclimb',{'unwc'},function(args, speaker)
	climb:Disconnect()
	cube:Destroy()
end)
...
addcmd('killall',{'ka'},function(args, speaker)
	
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		
		local Picked = Players[v]
		GrabLimb = Picked.Character.LeftFoot
		
		RunService.RenderStepped:Connect(function()

			Picked.Character.LeftFoot:BreakJoints()
			Picked.Character.LeftFoot.CanCollide = false
			Picked.Character.LeftFoot.Position = speaker.Character.Humanoid.RootPart.Position + (speaker.Character.Humanoid.RootPart.CFrame.LookVector * 2)
			Picked.Character.LeftFoot.Velocity = Vector3.new(0,0,0)
...
stopfreewheel = true
addcmd('freewheel',{},function(args, speaker)
    repeat wait(299)
        game:GetService("ReplicatedStorage").Modules.Net["RE/HourlySpin/FreeSpin"]:FireServer(1)
    until stopfreewheel == false
end)
execCmd("freewheel")
autoclicking = false
addcmd('autoclick',{},function(args, speaker)
    if autoclicking == true then
        ...
        --game:GetService("Players").LocalPlayer.Stamina
        --game:GetService("ReplicatedStorage").exe_storage.configuration.profile.walkspeed_max:FireServer(24)-- = 24

        repeat wait(0.1)
          --  speaker.Character:FindFirstChildOfClass('Humanoid').WalkSpeed = 24
          --  game:GetService("ReplicatedStorage").WaitForChild["Recovery Drink"]:FireServer(1)
          --  game:GetService("ReplicatedStorage").WaitForChild["Chicken Bucket"]:FireServer(1)

            --if Picked.Character.Humanoid.Health < 95 then
            --    game:GetService("ReplicatedStorage").WaitForChild["Chicken Bucket"]:FireServer()
            --end
          --  game:GetService("ReplicatedStorage").Modules.Net["RE/ShieldCompleteHeal"]:FireServer(1)

           -- game:GetService("ReplicatedStorage").Comidas["Chicken Bucket"].Handle.RemoteEvent:FireServer(1)

            game:GetService("ReplicatedStorage").Modules.Net["RE/ToiletWeaponActivated"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/TrashbagHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/PipeActivated"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/stopsignalHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/mopHit"]:FireServer(1)

            game:GetService("ReplicatedStorage"):WaitForChild("PUNCHEVENT"):FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/sprayRemote"]:FireServer(1)

            game:GetService("ReplicatedStorage").Modules.Net["RE/BeachShovelHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/panHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/taserRemote"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/flamethrowerFire"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/BatonHit"]:FireServer(1)


            game:GetService("ReplicatedStorage").Modules.Net["RE/pinkStopSignalHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/CrowbarHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/PurseActivated"]:FireServer(1)


            game:GetService("ReplicatedStorage").Modules.Net["RE/CrowbarHit"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/GoldenFlameThrowerFire"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/GoldenTaserRemote"]:FireServer(1)
            game:GetService("ReplicatedStorage").Modules.Net["RE/goldStopSignalHit"]:FireServer(1)
...
stophit = false
local failsafe1
addcmd('bodygrab',{'bg'},function(args, speaker)
    local root = getRoot(speaker.Character)
    stophit = true
	...
	for i,v in pairs(players) do
        ...
        if Picked ~= Plr then
    		...
    		failsafe1 = RunService.RenderStepped:Connect(function()
                if stophit == true then
                  ...
                  --  if Picked.Character.Humanoid.Health > 10 then
                  --      Picked:GetService("ReplicatedStorage").JALADADEPELOEVENT:FireServer()
                  --  end


                   if Picked.Character.Humanoid.Health < 10 then

					    --game:GetService("ReplicatedStorage"):WaitForChild("STOMPEVENT"):FireServer()

	                    root.CFrame = Picked.HumanoidRootPart.CFrame + Vector3.new(0,5,0)

                    end

                end

                if stophit == false then failsafe1:Disconnect() end
		    end)
        end
...
stophitall = false
local failsafe
addcmd('graball',{'bgall'},function(args, speaker)
    stophitall = true
    local Plr = game.Players.LocalPlayer
	...
	for i,v in pairs(players) do
    	local Picked = Players[v]
        if Picked ~= Plr then
            if not Picked:IsFriendsWith(Plr.UserId) then
    		    GrabLimb = Picked.Character.LeftFoot
    
    		    failsafe = RunService.RenderStepped:Connect(function()

                    if stophitall == true then
                    ...
                    if stophitall == false then failsafe:Disconnect() end
                end)
		    end
        end
...
addcmd('unbodygrab',{'unbg'},function(args, speaker)
    stophitall = false
    stophit = false
    if autoclicking == true then
        execCmd("autoclick")
    ...
    failsafe:Disconnect()
    failsafe1:Disconnect()
	--for _, person in bgrab do
	--	person:AddTag("dontkill")
	--end
	--GrabLimb.Position = Vector3.new(9999,9999,9999)
...
addcmd("taser", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Taser") then
        local Item = workspace.Cash.comprarTaser
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
        local GotIt = false
        spawn(function()
            while not GotIt do
                Plr.Character.HumanoidRootPart.CFrame = OldPos2
                Item:FindFirstChildOfClass("ProximityPrompt"):InputHoldBegin()
                wait(0.01)
                Item:FindFirstChildOfClass("ProximityPrompt"):InputHoldEnd()
                wait()
            end
        end)
        wait(0.2)
        Item.CFrame = game.Workspace.CurrentCamera.CFrame + game.Workspace.CurrentCamera.CFrame.LookVector * 20
        local Got = false
        Item.Sound.Played:Connect(function()
            Got = true 
        end)
        repeat
            wait()
...
addcmd("pan", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Pan") then
        local Item = workspace.Cash["Pan Buy button"]
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("shovel", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("BeachShovel") then
        local Item = workspace.Cash.botonComprarShovel
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("leash", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Dog Leash") then
        local Item = workspace.Cash.botonComprarDogLeash
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("mask", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Baddie Mask") then
        local Item = workspace.Cash.botonComprarMask
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("food", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Chicken Bucket") then
        local Item = workspace.Cash.comprarChickenBucket
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("drink", {}, function(args, speaker)
    local Plr = game.Players.LocalPlayer
    if not Plr.Backpack:FindFirstChild("Recovery Drink") then
        local Item = workspace.Cash.comprarRecovery
        local OldPos = Plr.Character.Head.CFrame
        local OldPos2 = Item.CFrame
        Item:FindFirstChildOfClass("ProximityPrompt").MaxActivationDistance = 1000000
        game.Workspace.CurrentCamera.CameraType = Enum.CameraType.Scriptable
...
addcmd("nails", {}, function(args, speaker)
	local root = getRoot(speaker.Character)
	local oldpos = root.CFrame
    execCmd('noclip')
    ...
    for i=1,500 do
        ...
        root.CFrame = CFrame.new(Vector3.new(489.346, 10, -247.57))
        root.CFrame = CFrame.new(Vector3.new(502.918, 10, -247.57))
        root.CFrame = CFrame.new(Vector3.new(517, 10, -247.57))
	    root.CFrame = CFrame.new(Vector3.new(527.84, 10, -268.70))
	    root.CFrame = CFrame.new(Vector3.new(528.0, 10, -280.8))
	    root.CFrame = CFrame.new(Vector3.new(497.4, 10, -292.13))
	    root.CFrame = CFrame.new(Vector3.new(511.1, 10, -292.13))
	    root.CFrame = CFrame.new(Vector3.new(525.26, 10, -292.13))
        game:GetService("ReplicatedStorage"):WaitForChild("PUNCHEVENT"):FireServer(1)
        wait(0.0005)
    end
    execCmd('clip')
	root.CFrame = oldpos
 --   print(game:GetService("Players").LocalPlayer.jaladaDePeloCharge)

end)



addcmd('grab',{'drag'},function(args, speaker)

	local players = getPlayer(args[1], speaker)
    local Plr = game.Players.LocalPlayer


	if Plr:FindFirstChild("PVPOFFGUI") and Plr:FindFirstChild("PVPOFFGUI").TextLabel == "" then
		print("Error")
		return
	end
	...
	for i,v in pairs(players) do
		...
		if Picked:FindFirstChild("PVPOFFGUI") and Picked:FindFirstChild("PVPOFFGUI").TextLabel == "" then
			print("Error")
			return
		end
        ...
        repeat
            ...
            --if plr:DistanceFromCharacter(picked.position) < 5 then
            --    return
            --end


           -- if Plr.jaladaDePeloCharge.Value ~= 100 then
         --   game:GetService("ReplicatedStorage"):WaitForChild("PUNCHEVENT"):FireServer(1)

            game:GetService("ReplicatedStorage").JALADADEPELOEVENT:FireServer()
            Picked.Character.LeftFoot:BreakJoints()
            Picked.Character.LeftFoot.CanCollide = false
            Picked.Character.LeftFoot.Position = speaker.Character.Humanoid.RootPart.Position + (speaker.Character.Humanoid.RootPart.CFrame.LookVector * 2)
            Picked.Character.LeftFoot.Velocity = Vector3.new(0,0,0)
		...
		until Picked:FindFirstChild("BeingCarried")
...
addcmd("hos", {}, function(args, speaker)
	local root = getRoot(speaker.Character)
	local oldpos = root.CFrame

    for i=1,30 do
     --works   game:GetService("ReplicatedStorage").JALADADEPELOEVENT:FireServer()
      --works  game:GetService("ReplicatedStorage"):WaitForChild("PUNCHEVENT"):FireServer(1)

	    root.CFrame = CFrame.new(Vector3.new(527.864, 10, -207.0))
        wait(0.1)
    end
	root.CFrame = oldpos
end)
